...
func main() {
	goth.UseProviders(
		...
		facebook.New("633076937906328", "b46722173e1ea17d407aea3263362380", "http://localhost:3000/auth/facebook/callback"),
		fitbit.New(os.Getenv("FITBIT_KEY"), os.Getenv("FITBIT_SECRET"), "http://localhost:3000/auth/fitbit/callback"),
		google.New("479205503773-r674qa8u7b186hbupe43oimrrc9mrhga.apps.googleusercontent.com", "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", "http://localhost:3000/callback/google"),
